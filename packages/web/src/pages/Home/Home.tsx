...
import { handleCreateCampaignClick } from '../../createCampaignHandoff';
import './Home.css';
...
export function Home() {
  ...
  const [desktopModalTags, setDesktopModalTags] = useState<string[] | null>(null);
  ...
  function handleGenerate() {
    void handleCreateCampaignClick(tags, navigate, setDesktopModalTags);
  }
        ...
        skeleton={
          <section className="home--hero">
            <div className="home--hero--prompt-card torn-parchment">
              ...
              <span className="skeleton home--skeleton--desc" />
          ...
          <>
            <section className="home--hero">
              ...
              <div className="home--hero--prompt-card torn-parchment">
                ...
                <p className="home--hero--prompt-desc">
                  Type a theme or detail and press comma or enter to add it as a tag — stack as many as you like.
                </p>
