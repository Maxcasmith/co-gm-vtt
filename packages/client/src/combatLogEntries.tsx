...
/** Plain-text lines (kind: 'text') only land in the log while showText is on — the structured attack/spell cards always do. */
export function useCombatLogEntries(showText: boolean): CombatLogPayload[] {
...
export function CombatLogEntries({ entries }: { entries: CombatLogPayload[] }) {
  return (
    <>
      {entries.map((entry, i) => {
